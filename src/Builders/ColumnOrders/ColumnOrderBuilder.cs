...
public sealed class ColumnOrderBuilder : ICssBuilder
{
    ...
    internal ColumnOrderBuilder(string order, Breakpoint? breakpoint = null)
    {
    ...
    public ColumnOrderBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public ColumnOrderBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public ColumnOrderBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public ColumnOrderBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public ColumnOrderBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    public ColumnOrderBuilder OnUltrawide => ChainWithBreakpoint(Breakpoint.Ultrawide);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private ColumnOrderBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
