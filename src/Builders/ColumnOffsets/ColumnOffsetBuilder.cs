...
public sealed class ColumnOffsetBuilder : ICssBuilder
{
    ...
    internal ColumnOffsetBuilder(string offset, Breakpoint? breakpoint = null)
    {
    ...
    public ColumnOffsetBuilder OnPhone => ChainWithBreakpoint(Breakpoint.Phone);
    public ColumnOffsetBuilder OnTablet => ChainWithBreakpoint(Breakpoint.Tablet);
    public ColumnOffsetBuilder OnLaptop => ChainWithBreakpoint(Breakpoint.Laptop);
    public ColumnOffsetBuilder OnDesktop => ChainWithBreakpoint(Breakpoint.Desktop);
    public ColumnOffsetBuilder OnWidescreen => ChainWithBreakpoint(Breakpoint.Widescreen);
    public ColumnOffsetBuilder OnUltrawide => ChainWithBreakpoint(Breakpoint.Ultrawide);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private ColumnOffsetBuilder ChainWithBreakpoint(Breakpoint breakpoint)
    {
        if (_rules.Count == 0)
        {
